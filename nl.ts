export const NL = {
    ...
    Toulouse: "Toulouse",
    ToulouseBonus:
        "<li>Titanium mijnen hebben 2x uitvoer</li><li>Uranium verrijkingscentrales hebben 2x productiviteit</li><li>Straalmotorenfabrieken hebben 2x capaciteit</li><li>Vliegtuigfabrieken hebben 2x productiviteit</li><li>Raketfabrieken gebruiken uranium in plaats van verrijkt uranium</li>",
    Rome: "Rome",
    RomeBonus:
    ...
    SiliconMine2xOutputDesc:
        "Silicon mijnen produceren 2x silicium maar verbruiken 50% meer energie en silicium transport kost 50% meer brandstof",
    CoalMine2xOutput: "Industriële Revolutie",
    CoalMine2xOutputDesc: "Steenkoolmijnen produceren 2x steenkool maar verbruiken 50% meer energie en steenkool transport kost 50% meer brandstof",
    AlMine2xOutput: "Aluminium Smelten",
    AlMine2xOutputDesc: "Aluminium mijnen produceren 2x aluminium en gebruiken 2x meer energie",
    LoggingCamp2xOutput: "Ontbossing",
    LoggingCamp2xOutputDesc: "Houthakkerskampen produceren 2x hout en hout transport kost 2x brandstof",
    HideResourceMovement: "Verberg Goederen Beweging",
    HideResourceMovementDesc:
        "Dit zal goederen bewegingen (de kleine puntjes) verbergen als standaard en enkel de beweging tonenals je een gebouw selecteerd",
